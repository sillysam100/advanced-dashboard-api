...
router.get("/page/:pageId", privateRoute, async (req: Request, res: Response) => {
    try{
...
router.get("/page/:pageId/registers", privateRoute, async (req: Request, res: Response) => {
    try {
...
router.post("/page/:pageId/register", privateRoute, async (req: Request, res: Response) => {
    try {
...
router.post("/page/:pageId/layout", privateRoute, async (req: Request, res: Response) => {
    try {
